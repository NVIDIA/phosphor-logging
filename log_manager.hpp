...
class Manager : public details::ServerObject<DeleteAllIface, CreateIface, NamespaceIface, CapacityIface>
{
  public:
    ...
    Manager(sdbusplus::bus::bus& bus, const std::string& path,
        ...
        details::ServerObject<DeleteAllIface, CreateIface, NamespaceIface, CapacityIface>(bus, path.c_str(), details::ServerObject<DeleteAllIface,CreateIface,NamespaceIface,CapacityIface>::action::defer_emit),
        manager(manager){};
