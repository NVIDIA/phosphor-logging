...
using RsyslogFwdActionInherit = sdbusplus::server::object::object<RsyslogFwd, DeleteInt>;
...
class RsyslogFwdAction : public RsyslogFwdActionInherit
{
  public:
    ...
    RsyslogFwdAction(sdbusplus::bus::bus& bus, const std::string& objPath,
        ...
        RsyslogFwdActionInherit(bus, objPath.c_str(), RsyslogFwdActionInherit::action::emit_interface_added),
    ...
    bool enabled() const override { return RsyslogFwd::enabled(); }

    RsyslogFwd::TransportProtocol transportProtocol(RsyslogFwd::TransportProtocol value) override;
    RsyslogFwd::TransportProtocol transportProtocol() const override { return RsyslogFwd::transportProtocol(); }

    RsyslogFwd::NetworkProtocol networkProtocol(RsyslogFwd::NetworkProtocol value) override;
    RsyslogFwd::NetworkProtocol networkProtocol() const override { return RsyslogFwd::networkProtocol(); }

    std::string address(std::string value) override;
    std::string address() const override { return RsyslogFwd::address(); }

    uint16_t port(uint16_t value) override;
    uint16_t port() const override { return RsyslogFwd::port(); }
